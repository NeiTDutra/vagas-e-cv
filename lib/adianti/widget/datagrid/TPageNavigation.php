...
class TPageNavigation
{
    ...
    private function getResume()
    {
        ...
        else
        {
            ...
            return _t('^1 to ^2 from ^3 records', $min, $max, number_format($this->getCount(), 0 , '', '.'));
        }
    }
    ...
    public function show()
    {
        ...
        {
            throw new Exception(_t('You must call ^1 before add this component', __CLASS__ . '::' . 'setAction()'));
        }
