...
class AdiantiCoreTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['pt_pt'][] = 'Excluir selecionados';
        ...
        $this->messages['pt_pt'][] = 'Campo para a ação ^1 não definido';
        $this->messages['pt_pt'][] = 'Campo ^1 não existe ou contém valor NULL';
        $this->messages['pt_pt'][] = 'Use o método ^1';
        $this->messages['pt_pt'][] = 'Formulário sem campos';
        $this->messages['pt_pt'][] = 'E-mail não enviado';
        ...
        $this->messages['pt_pt'][] = 'O campo ^1 não contém um CPF válido';
        $this->messages['pt_pt'][] = 'O campo ^1 contém um e-mail inválido';
        $this->messages['pt_pt'][] = 'O campo ^1 deve ser numérico';
        $this->messages['pt_pt'][] = 'Sem transação ativa com a base de dados';
        $this->messages['pt_pt'][] = 'Objeto não encontrado';
        $this->messages['pt_pt'][] = 'Objeto ^1 não encontrado em ^2';
        $this->messages['pt_pt'][] = 'Método ^1 não aceita valores NULOS';
        $this->messages['pt_pt'][] = 'Método ^1 deve receber um parâmetro do tipo ^2';
        $this->messages['pt_pt'][] = 'Estilo ^1 não encontrado em ^2';
        $this->messages['pt_pt'][] = 'Você deve executar o construtor de ^1';
        $this->messages['pt_pt'][] = 'Você deve executar ^1 antes de ^2';
        $this->messages['pt_pt'][] = 'Você deve passar o ^1 (^2) como parâmetro para ^3';
        $this->messages['pt_pt'][] = 'O parâmetro (^1) de ^2 é obrigatório';
        $this->messages['pt_pt'][] = 'O parâmetro (^1) do construtor de ^2 é obrigatório';
        $this->messages['pt_pt'][] = 'Você já adicionou um campo chamado "^1" ao formulário';
        $this->messages['pt_pt'][] = 'Fechar a aplicação ?';
        $this->messages['pt_pt'][] = 'Use addField() ou setFields() para definir os campos do formulário';
        $this->messages['pt_pt'][] = 'Verifique se a ação (^1) existe';
        $this->messages['pt_pt'][] = 'Informação';
        $this->messages['pt_pt'][] = 'Erro';
        $this->messages['pt_pt'][] = 'Exceção';
        $this->messages['pt_pt'][] = 'Questão';
        $this->messages['pt_pt'][] = 'A classe ^1 não foi aceita como argumento. O parâmetro deve ser subclasse de ^2.';
        $this->messages['pt_pt'][] = 'A classe ^1 não foi aceita como argumento. O parâmetro deve implementar ^2.';
        $this->messages['pt_pt'][] = 'A classe ^1 não foi encontrada. Verifique o nome da classe ou do arquivo. Eles devem coincidir';
        $this->messages['pt_pt'][] = 'Nome de propriedade reservado (^1) na classe ^2';
        $this->messages['pt_pt'][] = 'A ação (^1) deve ser estática para ser usada em ^2';
        $this->messages['pt_pt'][] = 'Tentativa de acesso à uma propriedade não existente (^1)';
        $this->messages['pt_pt'][] = 'Formulário não encontrado. Verifique se você passou o campo (^1) para o setFields()';
        $this->messages['pt_pt'][] = 'Classe ^1 não encontrada em ^2';
        $this->messages['pt_pt'][] = 'Você deve executar ^1 antes de adicionar o componente';
        $this->messages['pt_pt'][] = 'Driver não encontrado';
        $this->messages['pt_pt'][] = 'Buscar registro';
        $this->messages['pt_pt'][] = 'Campo';
        $this->messages['pt_pt'][] = 'Registro atualizado';
        $this->messages['pt_pt'][] = 'Registros atualizados';
        $this->messages['pt_pt'][] = 'Entrada';
        $this->messages['pt_pt'][] = 'Classe ^1 não encontrada';
        $this->messages['pt_pt'][] = 'Método ^1 não encontrado';
        $this->messages['pt_pt'][] = 'Verifique o nome da classe ou do arquivo';
        $this->messages['pt_pt'][] = 'Limpar';
        $this->messages['pt_pt'][] = 'Selecionar';
        $this->messages['pt_pt'][] = 'Você deve definir o campo para a ação (^1)';
        $this->messages['pt_pt'][] = 'A seção (^1) não foi fechada adequadamente';
        $this->messages['pt_pt'][] = 'O método ^1 somente aceita valores do tipo ^2 entre ^3 e ^4';
        $this->messages['pt_pt'][] = 'A classe interna ^1 não pode ser executada';
        $this->messages['pt_pt'][] = 'A versão mínima requerida para o PHP é ^1';
        $this->messages['pt_pt'][] = '^1 não definido. Você deve executar ^2 no ^3';
        $this->messages['pt_pt'][] = 'Database';
        $this->messages['pt_pt'][] = 'Construtor';
        $this->messages['pt_pt'][] = 'Registros';
        $this->messages['pt_pt'][] = 'Descrição';
        $this->messages['pt_pt'][] = 'Falha ao copiar arquivo para ^1';
        $this->messages['pt_pt'][] = 'Permissão negada';
        $this->messages['pt_pt'][] = 'Extensão não permitida';
        $this->messages['pt_pt'][] = 'Erro de hash';
        $this->messages['pt_pt'][] = 'Parâmetro (^1) inválido em ^2';
        $this->messages['pt_pt'][] = 'Atenção';
        $this->messages['pt_pt'][] = 'Nenhum registro encontrado';
        $this->messages['pt_pt'][] = '^1 a ^2 de ^3 registros';
        $this->messages['pt_pt'][] = 'Módulo PHP não encontrado';
        $this->messages['pt_pt'][] = 'O parâmetro (^1) de ^2 não deve ser vazio';
    }
