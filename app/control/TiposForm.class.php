...
class TiposForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_Tipos');
        $this->form->setFormTitle('Tipos');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Tipos
            $repository = new TRepository('Tipos');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new Tipos($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Tipos;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('permission'); // open a transaction
                $object = new Tipos($key); // instantiates the Active Record
