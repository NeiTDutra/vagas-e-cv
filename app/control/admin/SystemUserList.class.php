...
class SystemUserList extends TStandardList
{
    ...
    public function onDelete ($param) {
        ...
        try {
            ...
            $sth = $conn->prepare('delete FROM experiencias where id_user = ' . $_REQUEST['id'] . ';'); 
            $sth->execute();
            $result = $sth->fetchAll();

            $sth = $conn->prepare('delete FROM formacao where id_user = ' . $_REQUEST['id'] . ';'); 
            $sth->execute();
            $result = $sth->fetchAll();

            $sth = $conn->prepare('delete FROM idiomas where id_user = ' . $_REQUEST['id'] . ';'); 
            $sth->execute();
            $result = $sth->fetchAll();

            $sth = $conn->prepare('delete FROM user_tipos where id_user = ' . $_REQUEST['id'] . ';'); 
            $sth->execute();
            $result = $sth->fetchAll();

            $sth = $conn->prepare('delete FROM vaga_user where id_user = ' . $_REQUEST['id'] . ';'); 
            $sth->execute();
            $result = $sth->fetchAll();
