...
class LoginForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $login->placeholder = "Usuário, E-mail ou CPF";
        ...
        if ($_REQUEST['key'] > 0) {
            TSession::setValue('idvaga', $_REQUEST['key']);
        }
        ...
        $btn = $this->form->addActionLink('Criar Conta', new TAction(array('SystemRegistrationForm', 'onLoad')), '', false);
        $btn->class = 'btn btn-success';
        $btn->style = 'height: 40px;width: 90%;display: block;margin-top: 5px;font-size:17px;';
    ...
    public static function onLogin($param)
    {
        ...
        try
        {
            ...
            {    
                throw new Exception( _t('The field ^1 is required', _t('Unit')) );
            }
